 ...
 */
package com.example.everyoneassist.runtimepermissions;
...
public class PermissionsManager {
     ...
     * It is basically a less verbose method of using {@link android.support.v4.app.ActivityCompat#checkSelfPermission(Context, String)}
    ...
    public synchronized boolean hasPermission(@Nullable Context context, @NonNull String permission) {
        return context != null && (android.support.v4.app.ActivityCompat.checkSelfPermission(context, permission)
     ...
     * It is simpler than checking using {@link android.support.v4.app.ActivityCompat#checkSelfPermission(Context, String)}
     ...
     * that you call this from a Fragment where {@link android.support.v4.app.Fragment#getActivity()} could yield
    ...
    public synchronized void requestPermissionsIfNecessaryForResult(@Nullable Activity activity,
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            ...
            if (permList.isEmpty()) {
                ...
                android.support.v4.app.ActivityCompat.requestPermissions(activity, permsToRequest, 1);
            }
        }
    }
     ...
     * PermissionsResultAction to the queue to be notified of permissions being granted or
     * denied. In the case of pre-Android Marshmallow, permissions will be granted immediately.
     * The Fragment variable is used, but if {@link android.support.v4.app.Fragment#getActivity()} returns null, this method
     ...
     */
    @SuppressWarnings("unused")
    public synchronized void requestPermissionsIfNecessaryForResult(@NonNull android.support.v4.app.Fragment fragment,
                                                                    @NonNull String[] permissions,
                                                                    @Nullable PermissionsResultAction action) {
     ...
     * the {@link android.support.v4.app.Fragment#onRequestPermissionsResult(int, String[], int[])} method.
    ...
    private void doPermissionWorkBeforeAndroidM(@NonNull Activity activity,
        ...
        for (String perm : permissions) {
            if (action != null) {
                ...
                } else if (android.support.v4.app.ActivityCompat.checkSelfPermission(activity, perm)
    ...
    private List<String> getPermissionsListToRequest(@NonNull Activity activity,
        ...
        for (String perm : permissions) {
            ...
            } else if (android.support.v4.app.ActivityCompat.checkSelfPermission(activity, perm) != PackageManager.PERMISSION_GRANTED) {
